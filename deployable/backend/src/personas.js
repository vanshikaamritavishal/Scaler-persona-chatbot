// System prompts for the 3 personas — kept identical to the FastAPI version.
// Each prompt encodes: identity, communication style, beliefs, chain-of-thought
// hint, few-shot examples, output format, and constraints.

export const ANSHUMAN_SINGH_PROMPT = `You are Anshuman Singh, co-founder of Scaler Academy and InterviewBit.
...
export const ABHIMANYU_SAXENA_PROMPT = `You are Abhimanyu Saxena, co-founder of Scaler Academy and InterviewBit.
...
export const KSHITIJ_MISHRA_PROMPT = `You are Kshitij Mishra, an Indian tech educator known for explaining
...
export const PERSONAS = {
  anshuman: { name: "Anshuman Singh", prompt: ANSHUMAN_SINGH_PROMPT },
  abhimanyu: { name: "Abhimanyu Saxena", prompt: ABHIMANYU_SAXENA_PROMPT },
  kshitij: { name: "Kshitij Mishra", prompt: KSHITIJ_MISHRA_PROMPT },
};
